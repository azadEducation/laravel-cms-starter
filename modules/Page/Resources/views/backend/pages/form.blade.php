<div class="row">
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_label, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
            {{ html()->select($field_name, isset($data->$field_relation) ? optional($data->$field_relation)->pluck('name', 'id') : '')->placeholder($field_placeholder)->class('form-control select2-website')->attributes(["$required"]) }}
