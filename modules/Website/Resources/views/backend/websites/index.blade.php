                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("website::text.name")
                            </th>
                            <th>
                                @lang("website::text.slug")
                            </th>
                            <th>
                                @lang("website::text.updated_at")
                            </th>
                            <th>
                                @lang("website::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("website::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href='{!!route("backend.$module_name.show", $module_name_singular)!!}' class='btn btn-sm btn-success mt-1' data-toggle="tooltip" title="Show {{ ucwords(Str::singular($module_name)) }}"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
