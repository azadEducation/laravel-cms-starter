...
<header class="header header-sticky mb-2">
    <div class="container-fluid">
        ...
        <ul class="header-nav d-none d-md-flex">
            {{-- <li class="nav-item"><a class="nav-link" href="{{ route('frontend.index') }}"
                    target="_blank">{{ app_name() }}&nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i></a>
            </li> --}}
            <li class="nav-item dropdown">
                <a class="nav-link" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    aria-expanded="false">
                    <i class="fa-solid fa-project"></i>Projects  <i class="fa-solid fa-circle-chevron-right"></i> <small>{{ session('current_website') }}</small>
                </a>
                    @include('website::backend.includes.website_dropdown')
            </li>
        </ul>
        ...
        <div class="d-flex flex-row float-end">
            ...
            <script>
                ...
                $('#website').on('change', function() {
                    // Submit the form on dropdown change
                    $('#switchWebsiteForm').submit();
                });
            </script>
        </div>
    </div>
